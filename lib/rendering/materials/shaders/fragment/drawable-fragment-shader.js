...
export default class DrawableFragmentShader extends BaseFragmentShader {
  ...
  update(material, scale = 1, args = {}) {
    ...
    if (material.uniforms.scale) material.uniforms.scale.value = scale;
    ...
    if (material.uniforms.autoDraw) {
      if (material.uniforms.autoDraw.value) {
        material.uniforms.prevMousePosition.value = Inputs.mousePosition;
      }
    }
